...
class MenuModel extends CommonModel {
    ...
    protected $_validate = array(
        ...
        array('name,app,model,action,data', 'checkAction', '同样的记录已经存在！', 1, 'callback', CommonModel:: MODEL_INSERT   ),
    	array('id,name,app,model,action,data', 'checkActionUpdate', '同样的记录已经存在！', 1, 'callback', CommonModel:: MODEL_UPDATE   ),
