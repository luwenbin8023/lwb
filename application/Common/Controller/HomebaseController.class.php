...
class HomebaseController extends AppframeController {
	...
	public function __construct() {
		...
		parent::__construct();
                $this->assign("CUR_CONTROLLER",strtolower(CONTROLLER_NAME));
	}
	...
	function showCustomerService(){
		$customer_service_model = D("Common/CustomerService");
		$customerService=$customer_service_model->order("listorder asc")->select();
